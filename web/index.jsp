<%-- Document : index Created on : Jan 12, 2024, 3:52:10 PM Author : quann --%>
...
<html lang="en">
    ...
    <head>
        ...
        <!-- Page Title -->
        <title>MegaOne - Creative Studio</title>
        <!-- Favicon -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 pl-6">
                        <div class="main-title text-lg-left offset-md-1 mb-0 wow fadeInUp" data-wow-delay="300ms">
                            ...
                            <p class="pb-4 wow fadeInUp" data-wow-delay="500ms">Lorem ipsum dolor sit amet,
                                consectetur adipiscing elit. Sed augue diam, accumsan vitae justo non, euismod
                                aliquam lectus. Etiam elementum tortor quis risus posuere, in cursus arcu lobortis.
                            </p>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="main-title wow fadeIn" data-wow-delay="300ms">
                            <h2>We’re <span class="color-pink">Creative</span> Branding<br>and Corporate Identity
                                <span class="color-blue">Agency</span></h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="about-box mb-5 mb-lg-0 mx-auto bg-blue">
                            ...
                            <h5 class="font-weight-500 color-white mt-25px mb-15px text-capitalize">branding design
                            </h5>
                            <p class="font-weight-light color-white">Lorem dapibus, tortor eget turpis auctor,
                                convallis odio ac.</p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="col-lg-4 col-md-12 col-12">
                        <div class="about-box mb-0 mx-auto bg-pink">
                            ...
                            <h5 class="font-weight-500 color-white mt-25px mb-15px text-capitalize">web development
                            </h5>
                            <p class="font-weight-light color-white">Pellentesque habitant morbi tristique senectus
                                et malesuada.</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 order-md-0">
                                <div class="team-classic-content hvr-team2 blue">
                                    ...
                                    <p class="mt-3 mb-3 color-black">Lorem ipsum dolor sit amet, consectetur
                                        adipiscing elit augue.</p>
                                    <ul class="team-social">
                    ...
                    <div class="col-md-12">
                        <div class="quote-text text-center wow fadeInRight" data-wow-delay="300ms">
                            ...
                            <h2 class="font-weight-light mb-5 line-height-normal"><span
                                    class="color-yellow">Creativity</span> is allowing yourself to make mistakes Art
                                is knowing which ones to keep.</h2>
                        ...
                        <div class="col-md-12">
                            <div class="owl-carousel owl-theme testimonial-two hide-cursor mx-auto wow zoomIn"
                                ...
                                <div class="testimonial-item">
                                    <p class="color-black testimonial-para mb-15px"> Curabitur mollis bibendum
                                        luctus. Duis suscipit vitae dui sed suscipit. Vestibulum auctor nunc vitae
                                        diam eleifend, in maximus metus sollicitudin. Quisque vitae sodales lectus.
                                ...
                                <div class="testimonial-item hide-cursor">
                                    ...
                                    <div class="testimonial-post">
                                        <a href="javascript:void(0)" class="post"><img
                                                src="assets\img\testimonial2.png" alt="image"></a>
                                        <div class="text-content">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-12 p-lg-0">
                        <div class="split-container-setting style-three text-center">
                            ...
                            <p class="color-black mb-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit,
                                sed do eiusmodt temp to the incididunt ut labore et dolore magna aliqua. Ut enim ad
                                minim veniam, quis a nostr a exercitation ullamco laboris nisi ut aliquip.</p>
                            ...
                            <div class="text-center text-md-left">
                                ...
                                <p class="mb-3"> Email: <a href="mailto:email@website.com"
                                    ...
                                    Inquiries: <a href="mailto:email@website.com"
                                                  class="color-black">email@website.com</a> </p>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 text-center">
                        <ul class="footer-icons mb-4">
                            ...
                            <li><a href="javascript:void(0)" class="wow fadeInUp google"><i
