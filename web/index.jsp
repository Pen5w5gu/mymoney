<%@page contentType="text/html" pageEncoding="UTF-8" %>
    ...
    <body data-spy="scroll" data-target=".navbar-nav" data-offset="90">
        ...
        <header class="cursor-light">
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse d-none d-lg-block">
                        <ul class="nav navbar-nav mx-auto">
                            ...
                            <li class="nav-item"> <a href="#calender" class="scroll nav-link">Calender</a></li>
                            <li class="nav-item"> <a href="#input" class="scroll nav-link">Input</a></li>
                    ...
                    <div class="dropdown custom-dropdown dropup">

                        <a data-toggle="dropdown"
                            class="dropdown-link btn-setting btn-hvr-up btn-hvr-whatsapp color-black mr-lg-3 d-none d-lg-block"
                            aria-haspopup="true" aria-expanded="false" data-offset="0, 20"><i
                                class="fa-solid fa-user-secret "></i> ${name}</a>
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">


                            <a class="dropdown-item sidemenu_toggle"> <span class="icon icon-dashboard"></span>
                                Profile</a>
            ...
            <div class="side-menu center">
                ...
                <div style="padding-top: 20px" class="col-md-12 text-center">
                    <a href="javascript:void(0)" class="logo-full mb-4"><img src="assets/img/logo.png" alt=""></a>
                </div>

                <div class="profle">
                    <nav class="side-nav m-0">
                        <ul class="navbar-nav ">
                            <li class="nav-item"> <a href="#home" class="scroll nav-link"><i
                                        class="fa-solid fa-house"></i></a></li>
                            <li class="nav-item"> <a href="#calender" class="scroll nav-link"><i
                                        class="fa-solid fa-calendar-days"></i></a></li>
                            <li class="nav-item"> <a href="#input" class="scroll nav-link"><i
                                        class="fa-solid fa-pen"></i></a></li>
                            <li class="nav-item"> <a href="#pricing" class="scroll nav-link"><i
                                        class="fa-solid fa-clock"></i></a></li>
                            <li class="nav-item"> <a href="#clients" class="scroll nav-link"><i
                                        class="fa-solid fa-clock"></i></a></li>
                            <li class="nav-item"> <a href="#blog" class="scroll nav-link"><i
                                        class="fa-brands fa-blogger"></i></a></li>
                            <li class="nav-item"> <a href="#contact" class="scroll nav-link"><i
                                        class="fa-regular fa-address-card"></i></a></li>
                        </ul>
                    </nav>
                    <!--center-->
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="row align-items-center">
                                                        <div class="col-md-7">
                                                            ...
                                                            <p class="small mb-3"><span class="badge badge-dark">Ha Noi,
                                                                    VN</span></p>
                                                        </div>
                                                    </div>
        ...
        <section id="home" class="p-0 h-100vh cursor-light">
            ...
            <!--Main Slider-->
            <div id="rev_slider_8_1_wrapper" class="rev_slider_wrapper fullscreen-container" data-alias="weone"
                ...
                <div id="rev_slider_8_1" class="rev_slider fullscreenbanner" style="display:none;"
                    ...
                    <ul><!-- SLIDE  -->
                        ...
                        <li data-index="rs-36" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                            ...
                            <!-- LAYER Text -->
                            <div class="tp-caption color-yellow" data-x="['center','center','center','center']"
                                data-hoffset="['0','0','0','0']" data-y="['top','top','top','top']"
                                data-voffset="['270','200','100','55']" data-fontsize="['60','50','40','40']"
                                data-lineheight="['75','75','75','40']" data-width="['556','556','556','300']"
                                data-height="['none','none','none','87']" data-whitespace="nowrap" data-type="text"
                            ...
                            <div class="tp-caption color-black" data-x="['center','center','center','center']"
                                data-hoffset="['0','0','0','0']" data-y="['top','top','top','top']"
                                data-voffset="['348','260','155','98']" data-fontsize="['60','50','40','40']"
                                data-lineheight="['75','75','45','45']" data-width="['556','556','556','350']"
                                data-height="['none','none','none','87']" data-whitespace="nowrap" data-type="text"
                                data-responsive_offset="on"
                            ...
                            <div class="tp-caption color-black" data-x="['center','center','center','center']"
                                ...
                                data-voffset="['460','95','0','10']" data-whitespace="normal"
                                data-width="['630','630','550','440']" data-fontsize="['16','15','15','15']"
                                data-lineheight="['25','25','22','22']" data-type="text" data-responsive_offset="on"
                                ...
                                Hãy chi tiêu một cách thông minh.
                            </div>
                            ...
                            <div class="tp-caption tp-resizeme" data-x="['center','center','center','center']"
                                ...
                                <a href="#calender"
                                    class="scroll nav-link btn-setting color-black btn-hvr-up btn-hvr-yellow link">Xem
                                    chi tiết</a>
                            </div>
                            ...
                            <div class="tp-caption tp-resizeme" data-x="['center','center','center','center']"
                                ...
                                data-voffset="['100','0','-150','-150']" data-width="none" data-height="none"
                                ...
                                data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]"
                                data-paddingleft="[0,0,0,0]" style="z-index: 1;">
                            ...
                            <div class="tp-caption tp-resizeme" data-x="['right','right','right','right']"
                                ...
                                data-voffset="['160','80','-100','-100']" data-width="none" data-height="none"
                                data-whitespace="nowrap" data-type="image" data-responsive_offset="on"
                            ...
                            <div class="tp-caption tp-resizeme" data-x="['left','left','left','left']"
                                data-hoffset="['250','80','80','30']" data-y="['top','top','top','top']"
                                data-voffset="['227','-16','-16','-36']" data-width="none" data-height="none"
                                data-whitespace="nowrap" data-type="image" data-responsive_offset="on"
                                    ...
                                    <div class="animated-wrap slider-social icon-small">
                                        <div
                                            ...
                                            <a class="twitter-text-hvr" href="javascript:void(0);">
                                                <i class="fa-solid fa-coins font-20" aria-hidden="true"></i>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="tp-caption tp-resizeme" data-x="['left','left','left','left']"
                                data-hoffset="['83','66','20','20']" data-y="['bottom','bottom','bottom','bottom']"
                                data-voffset="['200','80','-100','-100']" data-width="none" data-height="none"
                                data-whitespace="nowrap" data-type="image" data-responsive_offset="on"
                                data-frames='[{"delay":50,"speed":1480,"frame":"0","from":"x:center;y:middle;opacity:0;","to":"o:1;","ease":"Power4.easeInOut"},{"delay":"wait","speed":350,"frame":"999","to":"opacity:0;","ease":"Power3.easeInOut"}]'
                                data-textalign="['inherit','inherit','inherit','inherit']" data-paddingtop="[0,0,0,0]"
                                data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]"
                            ...
                            <!-- LAYER Top Diamond -->
                            <div class="tp-caption tp-resizeme" data-x="['right','right','right','right']"
                                data-hoffset="['150','150','50','50']" data-y="['top','top','top','top']"
                                data-voffset="['70','-70','-130','-130']" data-width="none" data-height="none"
                                data-whitespace="nowrap" data-type="image" data-responsive_offset="on"
                                data-frames='[{"delay":50,"speed":1480,"frame":"0","from":"x:center;y:middle;opacity:0;","to":"o:1;","ease":"Power4.easeInOut"},{"delay":"wait","speed":350,"frame":"999","to":"opacity:0;","ease":"Power3.easeInOut"}]'
                                data-textalign="['inherit','inherit','inherit','inherit']" data-paddingtop="[0,0,0,0]"
                                data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]"
                            ...
                            <!-- LAYER Top Left -->
                            <div class="tp-caption" data-x="['left','left','left','left']"
                                data-hoffset="['-500','-500','5000','5000']" data-y="['top','top','top','top']"
                                data-voffset="['-100','-100','0','0']" data-whitespace="nowrap"
                                data-width="['394px','394px','394px','394px']"
                                data-height="['393px','393px','393px','393px']" data-responsive_offset="on"
                            ...
                            <div class="tp-caption" data-x="['left','left','left','left']"
                                data-hoffset="['1180','1180','5000','5000']" data-y="['top','top','top','top']"
                            ...
                            <!-- LAYER Top Right -->
                            <div class="tp-caption" data-x="['left','left','left','left']"
                                data-hoffset="['1280','1280','5000','5000']" data-y="['top','top','top','top']"
                                ...
                                data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]"
                                data-paddingleft="[0,0,0,0]" style="z-index: 1;">
                                <div class="rs-looped" data-easing="Power0.easeInOut" data-speed="0" data-xs="0"
                                    data-xe="0" data-ys="0" data-ye="0"><img src="assets\img\circle-top-right.png"
                                        alt="" data-ww="['381px','381px','381px','381px']"
                            ...
                            <!-- LAYER Arrows -->
                            <div class="tp-caption tp-resizeme" data-x="['left','left','left','left']"
                                data-hoffset="['30','30','-20','-100']" data-y="['top','top','top','top']"
                                ...
                                <div class="rs-looped rs-slideloop" data-easing="Power0.easeInOut" data-speed="30"
                                    data-xs="-90" data-xe="90" data-ys="0" data-ye="20"><img src="assets\img\arrows.png"
                                        alt="" data-ww="['97px','97px','97px','97px']"
        ...
        <!-- calander Starts -->
        <section id="calender" class="pb-0">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="main-title wow fadeIn" data-wow-delay="300ms">
                            <h5> Lorem ipsum dolor sit amet </h5>
                            <h2 class="mb-0">Expenditure<span class="color-pink"> Schedule</span> </h2>
                        </div>
                    </div>
                </div>
                <div class="row d-block">
                    ...
                    <div class="container flex">
                        <div class="calendar">
                            <div class="month flex">
                                ...
                                <div class="content">
                                    <h1 class="cbp-filter-style">Tháng 5</h1>
                                    <p>23 Tháng 5 Năm 2022</p>
                                </div>
                                <div class="next">
                    ...
                    <div class="detail flex cbp-l-filters-alignCenter">
                        <div class="income cbp-filter-item cbp-filter-style">
                            <p>INCOME:</p>
                            <h1>200.000đ</h1>
                        </div>
                        <div class="expense cbp-filter-item cbp-filter-style">
                            <p>EXPENSE:</p>
                            <h1>100.000đ</h1>
                        </div>
                        <div class="total cbp-filter-item cbp-filter-style">
                            <p>TOTAL:</p>
                            <h1>100.000đ</h1>
                        </div>
                    </div>
                ...
                <div class="row align-items-center position-relative">
                    <div class="col-md-12">
                        <div class="quote-text text-center wow fadeInRight" data-wow-delay="300ms">
                            <div class="quote d-flex justify-content-start mb-2rem"><i class="fa fa-quote-left"></i>
                            </div>
                            <h2 class="font-weight-light mb-5 line-height-normal"><span class="color-yellow">Cần
                                    lao</span> vi tiên thủ <br>
                                ...</h2>
                            <h3 class="color-pink">Huấn Rose</h3>
        ...
        <!--Input start-->
        <section class="about pb-0 overflow-visible" id="input">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 pl-6">
                        <div class="main-title text-lg-left offset-md-1 mb-0 wow fadeInUp" data-wow-delay="300ms">
                            <h5 class="wow fadeInUp" data-wow-delay="300ms"> Lorem ipsum dolor sit amet consectetur
                            </h5>
                            <h2 class="wow fadeInUp font-weight-light" data-wow-delay="400ms"> We are making <span
                                    class="color-pink">design</span> better for everyone</h2>
        ...
        <section>
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="main-title wow fadeIn" data-wow-delay="300ms">
                            <h2>We?re <span class="color-pink">Creative</span> Branding<br>and Corporate Identity <span
                                    class="color-blue">Agency</span></h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="about-box mb-5 mb-lg-0 mx-auto bg-blue">
                            ...
                            <p class="font-weight-light color-white">Lorem dapibus, tortor eget turpis auctor, convallis
                                odio ac.</p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="about-box mb-5 mb-lg-0 mx-auto bg-yellow">
                            ...
                            <p class="font-weight-light color-white">Etiam luctus, lacus maximus elementum dapibus
                                felis.
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-12 col-12">
                        <div class="about-box mb-0 mx-auto bg-pink">
                            ...
                            <p class="font-weight-light color-white">Pellentesque habitant morbi tristique senectus et
                                malesuada.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mt-66px mt-xs-4rem">
                    <div class="col-lg-4 col-md-6 col-sm-12 text-center mb-xs-5 wow fadeInUp">
                        <div class="pricing-item hvr-bg-blue">
                            ...
                            <div class="text-center">
                                <a href="javascript:void(0)"
                                    class="btn-setting color-black btn-hvr-up btn-blue btn-hvr-white">learn more</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 text-center mb-xs-5 wow fadeInUp">
                        <div class="pricing-item price-transform hvr-bg-yellow">
                            ...
                            <div class="text-center">
                                <a href="javascript:void(0)"
                                    class="btn-setting color-black btn-hvr-up btn-yellow btn-hvr-white">learn more</a>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12 text-center wow fadeInUp">
                        <div class="pricing-item hvr-bg-pink">
                            ...
                            <div class="text-center">
                                <a href="javascript:void(0)"
                                    class="btn-setting color-black btn-hvr-up btn-pink btn-hvr-white">learn more</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-12">
                            <div class="owl-carousel owl-theme testimonial-two hide-cursor mx-auto wow zoomIn"
                                ...
                                <div class="testimonial-item">
                                    <p class="color-black testimonial-para mb-15px"> Năm nay bác cũng ngoài 60 rồi, bác
                                        nói thật chứ đcm sống 60 năm trên đời đây là lần đầu tiên bác thấy có cái
                                        website tuyệt vời như thế này các cháu ạ!</p>
                                    <div class="testimonial-post">
                                        <a href="javascript:void(0)" class="post"><img src="assets\img\testimonial1.png"
                                                alt="image"></a>
                                ...
                                <div class="testimonial-item hide-cursor">
                                    <p class="color-black testimonial-para mb-15px"> "Trên đời này, có làm thì mới có
                                        ăn", chào các bạn tôi là tác giả của câu nói trên, Tôi đánh giá website 9,5
                                        điểm. </p>

                                    <div class="testimonial-post">
                                        <a href="javascript:void(0)" class="post"><img src="assets/img/testimonial2.jpg"
                                                alt="image"></a>
                                        <div class="text-content">
                                ...
                                <div class="testimonial-item">
                                    <p class="color-black testimonial-para mb-15px"> Curabitur mollis bibendum luctus.
                                        Duis
                                        suscipit vitae dui sed suscipit. Vestibulum auctor nunc vitae diam eleifend, in
                                        maximus metus sollicitudin. Quisque vitae sodales lectus. Nam porttitor justo
                                        sed mi
                                        finibus, vel tristique risus faucibus. </p>

                                    <div class="testimonial-post">
                                        <a href="javascript:void(0)" class="post"><img src="assets\img\testimonial3.png"
                                                alt="image"></a>
                                        <div class="text-content">
                                ...
                                <div class="testimonial-item">
                                    ...
                                    <div class="testimonial-post">
                                        <a href="javascript:void(0)" class="post"><img src="assets\img\testimonial4.png"
                                                alt="image"></a>
                                        <div class="text-content">
                                ...
                                <div class="testimonial-item">
                                    ...
                                    <div class="testimonial-post">
                                        <a href="javascript:void(0)" class="post"><img src="assets\img\testimonial5.png"
                                                alt="image"></a>
                                        <div class="text-content">
                                ...
                                <div class="testimonial-item">
                                    ...
                                    <div class="testimonial-post">
                                        <a href="javascript:void(0)" class="post"><img src="assets\img\testimonial6.png"
                                                alt="image"></a>
                                        <div class="text-content">
                                ...
                                <div class="testimonial-item">
                                    ...
                                    <div class="testimonial-post">
                                        <a href="javascript:void(0)" class="post"><img src="assets\img\testimonial7.jpg"
                                                alt="image"></a>
                                        <div class="text-content">
                                ...
                                <div class="testimonial-item">
                                    ...
                                    <div class="testimonial-post">
                                        <a href="javascript:void(0)" class="post"><img src="assets\img\testimonial8.jpg"
                                                alt="image"></a>
                                        <div class="text-content">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-12 p-lg-0">
                        <div class="split-container-setting style-three text-center">
                            ...
                            <p class="color-black mb-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do
                                eiusmodt temp to the incididunt ut labore et dolore magna aliqua. Ut enim ad minim
                                veniam,
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 p-0">
                        <div class="contact-box">
                            ...
                            <div class="text-center text-md-left">
                                ...
                                <!--Address-->
                                <p class="mb-3">Khu Công Nghệ Cao Hòa Lạc, km 29, Đại lộ, Thăng Long, Hà Nội, Việt Nam
                                </p>
                                ...
                                <p class="mb-3"> Email: <a href="mailto:quannthe171942@fpt.edu.vn"
                                    ...
                                    Inquiries: <a href="mailto:email@website.com"
                                        class="color-black">TỉnhNgu@website.com</a>
                                </p>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 text-center">
                        <ul class="footer-icons mb-4">
                            <li><a href="javascript:void(0)" class="wow fadeInUp facebook"><i
                                        class="fab fa-facebook-f"></i>
                                </a> </li>
                            <li><a href="javascript:void(0)" class="wow fadeInDown twitter"><i
                                        class="fab fa-twitter"></i>
                                </a> </li>
                            <li><a href="javascript:void(0)" class="wow fadeInUp google"><i class="fab fa-google"></i>
                                </a>
                            </li>
                            <li><a href="javascript:void(0)" class="wow fadeInDown linkedin"><i
                                        class="fab fa-linkedin-in"></i> </a> </li>
                            <li><a href="javascript:void(0)" class="wow fadeInUp instagram"><i
